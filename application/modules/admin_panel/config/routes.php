...
$route['admin/pay_plan']            = 'admin_panel/Payment/pay_plan';
$route['admin/pay_method']          = 'admin_panel/Payment/pay_method';
$route['admin/pay_form']            = 'admin_panel/Payment/pay_form';
$route['admin/pay_initiate_ajax']   = 'admin_panel/Payment/pay_initiate_ajax';
$route['admin/payment_response']    = 'admin_panel/Payment/payment_response';
$route['admin/pay_success/(:any)']  = 'admin_panel/Payment/pay_success/$1';
$route['admin/pay_success']         = 'admin_panel/Payment/pay_success';
$route['admin/pay_failed/(:any)']   = 'admin_panel/Payment/pay_failed/$1';
$route['admin/pay_failed']          = 'admin_panel/Payment/pay_failed';
$route['payment_webhook']                           = 'admin_panel/Payment/webhook';
// ---- Payment History & Reports ----
$route['admin/my_payment_history']                  = 'admin_panel/Payment/my_payment_history';
$route['admin/payment_receipt_pdf/(:any)']          = 'admin_panel/Payment/payment_receipt_pdf/$1';
$route['admin/online_payment_report']               = 'admin_panel/Payment/online_payment_report';
$route['admin/online_payment_report_pdf']           = 'admin_panel/Payment/online_payment_report_pdf';