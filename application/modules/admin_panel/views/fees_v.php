                                        ...
                                        <form class="cmxform form-horizontal tasi-form" method="post"
                                            ...
                                            if ($form_type == 'monthly_fees') { //monthly fees form
                                                ...
                                                if($all_yearly_fees_paid == 'no') {
                                                    ...
                                                    ?>
                                                    <span style="float: right; color:#5cc691; cursor:pointer;" onclick="alert('Yearly Fees Payment Done!')">All Yearly Fees Paid</span>
                                                    <br/><br/>
                                            <?php
                                                }
                                                    ?>
...
$('.input-group-addon').on('click', function() {
  $('#basicCalculator').calculator('show');
    ...
    $('#payment_type').change(function(){
        ...
        if($payment_ty == 'Bank' || $payment_ty == 'Online' || $payment_ty == 'Cash') {
