    ...
    <div class="sidebar-left-info">
        ...
        <ul class="nav nav-pills nav-stacked side-navigation">
            ...
            if($user_type == 4) {
                ...
                <li class="<?=($class_name == 'Payment' && in_array($method_name, ['pay_plan','pay_method','pay_form','pay_success','pay_failed'])) ? 'active' : ''; ?>">
                    <a href="<?=base_url();?>admin/pay_plan"><i class="fa fa-credit-card"></i> <span>Pay Fees Online</span></a>
                </li>

                <li class="<?=(($class_name == 'Payment') && ($method_name == 'my_payment_history')) ? 'active' : ''; ?>">
                    <a href="<?=base_url();?>admin/my_payment_history"><i class="fa fa-history"></i> <span>Online Payment History</span></a>
                </li>
                <?php
            }
            ...
            if($user_type == 1 or $user_type == 6) {
                ...
                if ($user_type == 1 || $prm_arr[61] == 1 || $prm_arr[62] == 1 || $prm_arr[63] == 1) { ?>
                    <li class="menu-list <?= ($class_name == 'Transactions' || ($class_name == 'Payment' && $method_name == 'online_payment_report')) ? 'active' : ''; ?>"><a href=""><i
                        ...
                        <ul class="child-list">
                            ...
                            <?php } ?>
                            <?php if ($user_type == 1) { ?>
                                <li class="<?= (($class_name == 'Payment') && ($method_name == 'online_payment_report')) ? 'active' : ''; ?>">
                                    <a href="<?= base_url(); ?>admin/online_payment_report"><i class="fa fa-credit-card"></i> Online Payment Report</a>
                                </li>
                            <?php } ?>
                        </ul>
                    </li>
