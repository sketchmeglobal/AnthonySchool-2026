...
//EOD;
    ...
    <div style="text-align:center;">
        ...
        <strong><span style="background-color: black;color: white; font-size: 12px;"> 2025 Concession Reports </span></strong>
    </div>
EOD;
    $pdf->setHtmlHeader($html_header, false);
...
EOD;
    ...
    public function print_all_tran_report() {
        if($this->input->post('submit') == 'print_all_tran_report') { //if form submitted
            ...
            $this->db->order_by("FM_HDR_COL_DATE"); //,STD_ROLLNO,Class_Name,Sec_Name
            $this->db->stop_cache();
...
EOD;
            ...
            foreach ($temp_table as $v) { //this loop is for all unique dates in which transaction was made
                ...
                <table >
                    ...
                    <tbody>
EOD;
// echo "<pre>"; print_r($hdr_monthly); die();
...
EOD;
            ...
            $grand_total_canara_bank = $grand_total_canara_bank;
            $grand_total_federal_bank = $grand_total_federal_bank;
            $html .= <<<EOD
<table cellspacing="2" style="font-size: 15px" border="1">
<thead>
<tr>
    <th width="130" align="left"> <strong>Grand Total</strong></th>
    <th width="650" align="left"> </th>
    <th width="50" align="center"><strong>$grand_total_online</strong></th>
...
EOD;
            ...
            <table cellspacing="2">
                ...
                <tr style="border: 1px solid black;">
                    <th width="500"><strong> Class Sec</strong></th>
...
EOD;
            ...
            foreach ($hdr_monthly as $index) {
                ...
                $html .= '<tr>
                        <td width="500">'.$index['class_sec'].'</td>
...
EOD;
        ...
        <td width="50"><strong>$company->COM_FIN_YEAR</strong></td>
    </tr>
...
// Print text using writeHTMLCell()
    ...
    public function ajax_fetch_classes_by_class_type() {
        ...
        if($class_type_id !== "all"){
            if(!in_array('all', $class_type_id)){
...
EOD;
  ...
  <tr>
    <td style="width: 17%; vertical-align: center;"> 
      <img src="https://stanthonyschooledu.org/2025-26/assets/img/reportlogo2.png" style="width: 100px;" alt="ST. Anthony's High School Logo">
    </td>
