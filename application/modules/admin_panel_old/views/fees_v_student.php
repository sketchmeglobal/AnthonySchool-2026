                                ...
                                elseif ($form_type == 'yearly_fees') { //yearly fees form
                                    ...
                                    <form class="cmxform form-horizontal tasi-form" id="add_yearly_fees_form"
                                        ...
                                        <div class="form-group" style="text-align:right;">
                                            <div class="col-lg-offset-2 col-lg-10">
                                                <button class="btn btn-success w-auto md:hidden sm:block ml-auto" type="submit" name="submit"
                                        ...
                                        <div class="form-group">
                                            <label for="payment_type" class="control-label col-lg-2 text-danger">Payment
                                                Type *</label>
                                            <div class="col-lg-10 iconic-input">
                                                <select class="form-control round-input" id="payment_type" <?php if($user_type == "4"){echo "disabled";}?>
                                                        name="payment_type" required>
                                                   
                                                    <option value="Bank" <?php if($user_type == "4"){echo "selected";}?> <?=($payment_type == 'Bank')?'selected':''?>>Bank</option>
                                                </select>
                                            </div>
                                        </div>
                                                        ...
                                                        <table class="table table-striped">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th class="success" style="text-align: center;">
                                                                    <span class="total_fees" id="paying_fee"><?= $total_fees; ?></span>
                                                                </th>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-lg-4 iconic-input">
                                                <span class="h3"><kbd><strong><span class="fa fa-inr"></span> <span
                                                                    class="net_fees"><?= $total_fees; ?></span></strong></kbd></span>
                                            </div>
                                        </div>
