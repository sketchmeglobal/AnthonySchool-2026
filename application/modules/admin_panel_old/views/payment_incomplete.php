  ...
  border-radius: 8px;
    ...
    <body>
      ...
      <div style="border-radius:200px; height:200px; width:200px; background: #F8FAF5; margin:0 auto;">
        <i class="fa fa-close" style="font-size: 11rem;"></i>
      </div>
        <h1>!Oops something went wrong <br> Thankyou </h1> 
        
        <p>Your refarence number: <b> <?=($sbi_ref_no == null)? ' N/A' : $sbi_ref_no?></b>  for this payment .</p>
