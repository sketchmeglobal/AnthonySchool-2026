                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-2">
                                        <button value="inst_filter" class="btn btn-primary button_search" type="submit"><i class="fa fa-search"> Search</i></button>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <table id="book_return_details_tables" class="table data-table dataTable">
                                <thead>
                                    <tr>
                                        <th>Book Name</th>
                                        <th>Student Name</th>
...
<script>
    $(document).ready(function() {
        $('#book_return_details_tables').DataTable( {
            "processing": true,
            "language": {
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?=base_url('ajax_book_return_table_data')?>",
                "type": "POST",
                "dataType": "json",
            },
    ...
    $(document).on('click', '.button_search', function(){
        ...
        $('#book_return_details_tables').DataTable().destroy();
        $('#book_return_details_tables').DataTable( {
            "processing": true,
            "language": {
                processing: '<img src="<?=base_url('assets/img/ellipsis.gif')?>"><span class="sr-only">Processing...</span>',
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?=base_url('library/form_return_book_filter')?>",
                "type": "POST",
                "data": {
    ...
    $(document).on('click', '.confirm', function(){
        ...
        $did = $(this).attr('del-id');
            ...
            $.ajax({
                url: "<?= base_url('library/form_book_return') ?>",
                dataType: 'json',
                type: 'POST',
                data: {id: $did},
                success: function (returnData) {
                    ...
                    //refresh table
                    $("#book_return_details_tables").DataTable().ajax.reload();
                },
