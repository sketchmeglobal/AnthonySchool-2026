...
var style1_pran = Array.prototype.slice.call(document.querySelectorAll('.js-switch-style1_pran'));
style1_pran.forEach(function(element) {
    var switchery = new Switchery(element, { color: '#8ddf00', secondaryColor: '#ff0080' });
});
